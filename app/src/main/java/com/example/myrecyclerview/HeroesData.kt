...
object HeroesData {
  ...
  private val heroDetails = arrayOf(
    "Salah seorang ulama dan khatib terkemuka di Masjid Besar Kasultanan Yogyakarta pada masa itu," +
            "dan ibu dari K.H. Ahmad Dahlan adalah puteri dari H. Ibrahim yang juga menjabat" +
            "penghulu Kesultanan Ngayogyakarta Hadiningrat pada masa itu. KH. Ahmad Dahlan telah" +
            "mempelopori kebangkitan ummat Islam untuk menyadari nasibnya sebagai bangsa terjajah" +
    ...
    "Jenderal TNI Anumerta Ahmad Yani (juga dieja Achmad Yani; lahir di Purworejo, Jawa Tengah, 19" +
            ...
            "adalah komandan Tentara Nasional Indonesia Angkatan Darat, dan dibunuh oleh anggota" +
            "Gerakan 30 September saat mencoba untuk menculik dia dari rumahnya.",
    "Sutomo (lahir di Surabaya, Jawa Timur, 3 Oktober 1920 – meninggal di Padang Arafah, Arab Saudi," +
            "7 Oktober 1981 pada umur 61 tahun) lebih dikenal dengan sapaan akrab oleh rakyat" +
    ...
    "Jenderal TNI (Purn.) Gatot Soebroto (lahir di Sumpiuh, Banyumas, Jawa Tengah, 10 Oktober 1907" +
            "– meninggal di Jakarta, 11 Juni 1962 pada umur 54 tahun) adalah tokoh perjuangan" +
    ...
    "Raden Mas Soewardi Soerjaningrat (EBI: Suwardi Suryaningrat, sejak 1922 menjadi Ki Hadjar" +
            ...
            "Hajar Dewantoro; lahir di Pakualaman, 2 Mei 1889 – meninggal di Yogyakarta, 26 April" +
            "1959 pada umur 69 tahun; selanjutnya disingkat sebagai \"Soewardi\" atau \"KHD\")" +
            "adalah aktivis pergerakan kemerdekaan Indonesia, kolumnis, politisi, dan pelopor" +
            "pendidikan bagi kaum pribumi Indonesia dari zaman penjajahan Belanda. Ia adalah pendiri" +
            "Perguruan Taman Siswa, suatu lembaga pendidikan yang memberikan kesempatan bagi para" +
            "pribumi untuk bisa memperoleh hak pendidikan seperti halnya para priyayi maupun" +
            "orang-orang Belanda.",
    "Dr.(HC) Drs. H. Mohammad Hatta (lahir dengan nama Mohammad Athar, dikenal sebagai Bung Hatta;" +
            "lahir di Fort de Kock (sekarang Bukittinggi, Sumatera Barat), Hindia Belanda, 12" +
            "Agustus 1902 – meninggal di Jakarta, 14 Maret 1980 pada umur 77 tahun) adalah tokoh" +
            "pejuang, negarawan, ekonom, dan juga Wakil Presiden Indonesia yang pertama. Ia bersama" +
    ...
    "Jenderal Besar Raden Soedirman (EYD: Sudirman; lahir 24 Januari 1916 – meninggal 29 Januari" +
            ...
            "Nasional Indonesia. Menjadi panglima besar Tentara Nasional Indonesia pertama, ia" +
            "secara luas terus dihormati di Indonesia. Terlahir dari pasangan rakyat biasa di" +
            "Purbalingga, Hindia Belanda, Soedirman diadopsi oleh pamannya yang seorang priyayi." +
            ...
            "keguruan, pada 1936 ia mulai bekerja sebagai seorang guru, dan kemudian menjadi kepala" +
            "sekolah, di sekolah dasar Muhammadiyah; ia juga aktif dalam kegiatan Muhammadiyah" +
            "lainnya dan menjadi pemimpin Kelompok Pemuda Muhammadiyah pada tahun 1937. Setelah" +
            "Jepang menduduki Hindia Belanda pada 1942, Soedirman tetap mengajar. Pada tahun 1944," +
            "ia bergabung dengan tentara Pembela Tanah Air (PETA) yang disponsori Jepang, menjabat" +
    ...
    "Dr.(H.C.) Ir. H. Soekarno (ER, EYD: Sukarno, nama lahir: Koesno Sosrodihardjo) (lahir di" +
            "Surabaya, Jawa Timur, 6 Juni 1901 – meninggal di Jakarta, 21 Juni 1970 pada umur 69" +
            "tahun) adalah Presiden pertama Republik Indonesia yang menjabat pada periode 1945–1967." +
            ...
            "mencetuskan konsep mengenai Pancasila sebagai dasar negara Indonesia dan ia sendiri" +
            "yang menamainya.",
    "Prof. Mr. Dr. Soepomo (Ejaan Soewandi: Supomo; lahir di Sukoharjo, Jawa Tengah, 22 Januari 1903" +
            "– meninggal di Jakarta, 12 September 1958 pada umur 55 tahun) adalah seorang pahlawan" +
            "nasional Indonesia. Soepomo dikenal sebagai arsitek Undang-undang Dasar 1945, bersama" +
    ...
    "Tan Malaka atau Ibrahim gelar Datuk Sutan Malaka (lahir di Nagari Pandam Gadang, Suliki, Lima" +
            ...
            "Timur, 21 Februari 1949 pada umur 51 tahun) adalah seorang pembela kemerdekaan" +
            "Indonesia, tokoh Partai Komunis Indonesia, juga pendiri Partai Murba, dan merupakan" +
